...
var OverrideBuildChainFunc func(apiHandler http.Handler, c *Config) (secure http.Handler)
...
func NewConfig(codecs serializer.CodecFactory) *Config {
	...
	if OverrideBuildChainFunc != nil {
		c.BuildHandlerChainFunc = OverrideBuildChainFunc
	}
