...
import (
	...
	samplecontrollerk8siov1alpha1 "github.com/rancher/wrangler/sample/pkg/apis/samplecontroller.k8s.io/v1alpha1"
	versioned "github.com/rancher/wrangler/sample/pkg/generated/clientset/versioned"
	internalinterfaces "github.com/rancher/wrangler/sample/pkg/generated/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/rancher/wrangler/sample/pkg/generated/listers/samplecontroller.k8s.io/v1alpha1"
...
func NewFilteredFooInformer(client versioned.Interface, namespace string, resyncPeriod time.Duration, indexers cache.Indexers, tweakListOptions internalinterfaces.TweakListOptionsFunc) cache.SharedIndexInformer {
	return cache.NewSharedIndexInformer(
		...
		&samplecontrollerk8siov1alpha1.Foo{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *fooInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&samplecontrollerk8siov1alpha1.Foo{}, f.defaultInformer)
}
