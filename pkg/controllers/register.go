...
func Register(ctx context.Context, targetNamespace string, pContext, vContext *cluster.Context) {
	...
	pod.Register(ctx, targetNamespace, pContext.Apply, pContext.Core.Pod(), vContext.Core.Pod(), vContext.K8s.CoreV1(), pContext.Core.Service())
